                    ...
                    <form action="{{ route('admin.obat.update', $obat->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="{{ old('name', $obat->name) }}" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('dosage') is-invalid @enderror"
                                   id="dosage" name="dosage" value="{{ old('dosage', $obat->dosage) }}">
                            @error('dosage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('stock') is-invalid @enderror"
                                      id="stock" name="stock" rows="3">{{ old('stock', $obat->stock) }}</textarea>
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
